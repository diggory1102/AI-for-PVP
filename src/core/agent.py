...
class AIAgent:
    ...
    def generate_response(self, query, context_docs=None, current_image=None):
        ...
        system_instruction = (
            ...
            "và hỗ trợ người dùng giành chiến thắng bằng cách đưa ra lời khuyên chiến thuật hoặc thực hiện các thao tác chính xác.\n\n"
            "NGÔN NGỮ BẮT BUỘC:\n"
            ...
            "2. Tư duy từng bước (Chain-of-Thought): Phân tích cơ chế đội đối thủ (ví dụ: 'Họ dùng nhiều khiên') -> Suy ra cơ chế khắc chế (ví dụ: 'Cần tướng xóa khiên hoặc sát thương chuẩn') -> Đề xuất lựa chọn phù hợp nhất.\n"
            "3. Nếu người dùng chỉ hỏi xin lời khuyên/chiến thuật (không yêu cầu bấm), hãy giải thích cơ chế bằng tiếng Việt và gợi ý các tướng nên pick, KHÔNG xuất lệnh [CLICK].\n\n"
            ...
            "Ví dụ 3:\n"
            "User: Quay về sảnh nếu trận đấu đã kết thúc\n"
            "Assistant: Trận đấu đã xong và màn hình đang hiện phần thưởng. Tôi sẽ bấm nút Xác nhận ở tọa độ (400, 300): [CLICK: 400, 300, LABEL: \"Xác nhận\"]. Đã hoàn thành mục tiêu: [FINISHED]\n\n"
        )
